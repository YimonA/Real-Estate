...
const Pricing = () => {
  const plans = [
    {icon:<CgTrees />, name: "Basic", cost: "19"},
    {icon:<BsShield />, name: "Premium", cost: "39"},
    {icon:<FaRocket />, name: "Basic", cost: "99"},
  ];
  return (
        ...
        <div className="container mx-auto px-4 lg:px-24">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-[30px] gap-y-[50px]">
            {plans.map((plan,index)=>{
              return (
                <div key={index} className="rounded-md shadow hover:shadow-xl  duration-500 ease-in-out  dark:bg-slate-900 dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700">
