...
const Footer = () => {
  ...
  const navUsefulLinks = [
    { url: "/features", name: "Features" },
    { url: "/list-sidebar", name: "Listing" },
    ...
    <div className=" container-fluid bg-slate-900 dark:bg-slate-800 px-3 lg:px-[18rem] mt-24">
      <div className=" container mx-auto relative">
        ...
        <div className=" flex flex-col lg:flex-row justify-between pb-9 pt-52 px-3 lg:pt-36 mb-3 lg:px-2">
          ...
          <div className=" basis-4/12 flex flex-col lg:flex-row justify-evenly items-start mt-5 mb-3">
            <div className=" mb-5">
              <p className=" text-white mb-3 text-md font-semibold">Company</p>
              <ul className="  text-gray-300">
                {navCompany?.map((link, index) => {
                  return (
          ...
          <div className=" basis-3/12 fs-[17px] mt-5 mb-3">
            <p className=" text-white mb-3 text-md font-semibold">
              Contact Details
            </p>
            <div>
        ...
        <div className="border-t border-gray-800 dark:border-gray-700">
          <div className=" flex flex-col lg:flex-row justify-between items-center py-5 gap-3 ">
            ...
            <div className=" basis-5/12 flex gap-1 items-center">
              {socialIcons.map((icon, index) => {
                return (
                  <button
                    key={index}
                    className="mx-1 p-1 fs-[17px] leading-[24px] text-slate-400 hover:text-white  border border-gray-800 dark:border-gray-700  hover:bg-[#138a3f] rounded-lg myFooterBtn"
                  >
                    {icon}
                  </button>
                );
